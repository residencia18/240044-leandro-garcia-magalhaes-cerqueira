...
import com.example.springsecurity.service.AuditService;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.example.springsecurity.service.*.*(..)) && !target(com.example.springsecurity.service.AuditService)")
